...
The accompanying workflow implementations (when available) serve only as **reference implementations** of the architecture—not as the architecture itself.
...
This separation allows architectural concepts to remain reusable while implementations evolve independently.
...
Rather than collecting workflow exports, this project aims to build a knowledge base focused on automation engineering and architectural thinking.
